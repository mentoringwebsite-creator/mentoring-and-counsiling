        ...
        <section className="flex-1 flex flex-col justify-center px-5 py-10 md:px-8 md:py-14 animate-fade-in">
          <div className="mx-auto flex w-full max-w-[1180px] flex-col justify-center gap-10">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4 inline-flex items-center rounded-full border border-blue-100 bg-blue-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-blue-700 shadow-sm">
            ...
            <div className="grid gap-6 md:grid-cols-2 md:gap-6 xl:gap-7 animate-scale-in">
              {roles.map((role) => {
                ...
                return (
                  ...
                  >
                    <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 transition-all duration-300 group-hover:scale-110 group-hover:bg-blue-100 md:h-[88px] md:w-[88px]">
