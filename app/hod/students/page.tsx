        ...
        <div className="grid gap-6 p-4 md:p-6 lg:grid-cols-[260px_minmax(0,1fr)] w-full min-w-0">
          ...
          <div className="space-y-6 w-full min-w-0">
            <div className="portal-card">
              <h2 className="text-2xl font-semibold">Department Student Roster</h2>
              <p className="mt-2 text-slate-600">Review department students, monitor assigned student performance, and track unassigned student queues.</p>
            </div>
