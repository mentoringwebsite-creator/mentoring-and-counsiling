                      ...
                      <div className="grid gap-5 md:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                          ...
                          {clubs.length > 0 ? (
                              ...
                              {clubs.map((c: any, i: number) => (
                                <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-100">
                                  <div>
                                    ...
                                    <div className="text-[10px] text-slate-500 font-semibold">{c.role} • Joined {c.joined}</div>
                                  </div>
                                  <span className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[9px] font-extrabold bg-emerald-50 text-emerald-800 border border-emerald-200">
                            ...
                            <div className="p-6 text-center text-xs text-slate-400 italic">No clubs recorded</div>
                          )}
                        </div>
                          ...
                          {certifications.length > 0 ? (
                            <div className="space-y-3">
                              {certifications.map((cert: any, i: number) => (
                                <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-100">
                                  <div className="min-w-0 flex-1">
                                    <div className="font-bold text-xs text-slate-800 truncate">{cert.name}</div>
                                    {cert.link && (
                                      <a href={cert.link} target="_blank" rel="noopener noreferrer" className="text-[10px] font-bold text-emerald-700 hover:underline flex items-center gap-1 mt-0.5">
                            ...
                            <div className="p-6 text-center text-xs text-slate-400 italic">No certifications uploaded</div>
                          )}
                        </div>
                      </div>
