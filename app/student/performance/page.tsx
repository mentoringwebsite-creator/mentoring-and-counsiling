            ...
            {loading ? (
              <div className="portal-card flex h-[400px] items-center justify-center">
                <div className="flex flex-col items-center gap-3 text-slate-500">
                  ...
                  <span className="text-sm font-semibold">Building dashboard...</span>
                </div>
              </div>
            ) : (() => {
              ...
              return (
                <div className="flex flex-col xl:flex-row gap-4 h-full min-h-0 overflow-hidden w-full">
                  ...
                  <div className="w-full xl:w-[320px] flex flex-col gap-4 h-full min-h-0 shrink-0 animate-fadeIn">
                    ...
                    <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm flex flex-col items-center text-center relative overflow-hidden group shrink-0">
                      ...
                      <div className="w-full space-y-2.5 text-left text-xs">
                        ...
                        {profileData.alternate_phone && (
                          <div className="flex items-center gap-2.5">
                            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-slate-50 border border-slate-100 text-[#1c5644]">
                  ...
                  <div className="flex-1 flex flex-col gap-4 h-full min-h-0">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1.35fr_1fr] gap-4 min-h-0 flex-1">
                      ...
                      <div className="rounded-[24px] border border-slate-150 bg-white p-4 shadow-sm h-full flex flex-col min-h-0 animate-fadeIn">
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                              {activeChart === 'cgpa' ? (
                                <AreaChart data={cgpaProgressData} margin={{ top: 5, right: 5, left: -30, bottom: 5 }}>
                                  <defs>
                                    <linearGradient id="profileCgpaGrad" x1="0" y1="0" x2="0" y2="1">
                                  ...
                                  <Area type="monotone" name="CGPA" dataKey="CGPA" stroke="#1c5644" strokeWidth={3} fillOpacity={1} fill="url(#profileCgpaGrad)" dot={{ r: 3 }} activeDot={{ r: 5 }} connectNulls isAnimationActive={true} animationDuration={600} />
                                </AreaChart>
                              ) : activeChart === 'sgpa' ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-4 shrink-0 h-[200px] min-h-0">
                      ...
                      {analysis && (
                        <div className="rounded-[24px] border border-slate-150 bg-[linear-gradient(180deg,#ffffff,#fafcfb)] p-4 shadow-sm relative overflow-hidden h-full flex flex-col min-h-0 animate-fadeIn">
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-[28px] bg-white p-6 shadow-xl border border-slate-100">
              ...
              <form onSubmit={handleCertSubmit} className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <input type="url" value={certLink} onChange={(e) => setCertLink(e.target.value)} placeholder="https://..." className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-3.5 py-3 text-xs focus:border-emerald-655 focus:bg-white focus:outline-none" />
                </div>
                <div>
