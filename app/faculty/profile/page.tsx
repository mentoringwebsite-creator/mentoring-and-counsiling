...
export default function FacultyProfilePage() {
  ...
  return (
    <ProtectedRoute role="faculty">
      <PageShell title="Faculty Profile" subtitle="Sreenidhi Institute of Science and Technology">
        <div className="grid gap-6 px-5 py-5 md:px-8 md:py-8 xl:grid-cols-[260px_minmax(0,1fr)]">
          <Sidebar active="/faculty/profile" items={facultySidebarItems} />
                  ...
                  <div className="flex flex-col justify-center text-portal-ink">
                    ...
                    <div className="grid gap-x-6 gap-y-4 sm:grid-cols-2 text-sm">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="text-slate-400 font-medium text-xs uppercase tracking-wider">Year Joined</div>
                          <div className="font-semibold text-slate-800 mt-0.5">{profile.yearJoined}</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3 sm:col-span-2">
                        ...
                        <div>
                          <div className="text-slate-400 font-medium text-xs uppercase tracking-wider">Subjects Taught</div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="text-slate-400 font-medium text-xs uppercase tracking-wider">Faculty Email</div>
