                ...
                <div className="mt-4 transition-all duration-300">
                  ...
                  {activeTab === 'academics' && (
                    <div className="space-y-5">
                      ...
                      {/* Academic Semester Ledger Table (Hidden until a semester is clicked) */}
                      {selectedLedgerSem !== null && (
                        <div id="academic-subjects-section" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm space-y-4 scroll-mt-6">
                          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 pb-3">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <button
                                onClick={() => setSelectedLedgerSem(null)}
                                className="rounded-full p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition"
                                title="Close / Hide Ledger Table"
                              >
                                <X className="h-4 w-4" />
                              </button>
                            </div>
